...
//help to check the formats of the candidate referral
...
public int checkFormat(String input1){
		 ...
		 }catch (IOException  | EncryptedDocumentException | IndexOutOfBoundsException| InvalidFormatException ex) {
...
public void keyPressed(KeyEvent e) {d.dispose();}
